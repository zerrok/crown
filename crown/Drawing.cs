...
namespace crown {
    class Drawing {
        public static void drawTerrain(SpriteRender spriteRender) {
            ...
            GetRenderableTiles(out startCol, out endCol, out startRow, out endRow);
        ...
        public static void GetRenderableTiles(out int startCol, out int endCol, out int startRow, out int endRow) {
